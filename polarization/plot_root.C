void plot_root()
{
  ...
  costh[0][0]->SetTitle("7 TeV cos^{2}#theta_{HX} transverse");
  ...
  costh[2][0]->SetTitle("7 TeV cos^{2}#theta_{HX} longitudinal");
  ...
  // draw the phi plots
  phi[0][0]->SetTitle("7 TeV cos2#phi_{HX} transverse");
  phi[0][0]->Draw("error");
  for(int i = 0; i < y_bins; i++) {
  ...
  phi[2][0]->SetTitle("7 TeV cos2#phi_{HX} longitudinal");
  phi[2][0]->Draw("error");
  for(int i = 0; i < y_bins; i++) {
  ...
  phith[0][0]->SetTitle("7 TeV sin2#theta_{HX}cos#phi_{HX} transverse");
  ...
  phith[2][0]->SetTitle("7 TeV sin2#theta_{HX}cos#phi_{HX} longitudinal");
